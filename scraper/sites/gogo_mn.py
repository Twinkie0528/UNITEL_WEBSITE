...
def scrape_gogo(output_dir: Path) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        logger.warning("gogo.mn fetch failed: %s", exc)
        return captures
...
def _capture_image(
    ...
    *,
    ...
    context = f"tag=img classes={classes} id={element_id}"
